...
/**
 * Clase que proporciona una interfaz de usuario para gestionar proyectos y tareas.
 * <p>
 * La clase contiene el método principal que ejecuta un menú interactivo para crear proyectos, agregar tareas,
 * crear desarrolladores, actualizar el estado de las tareas, y generar reportes.
 * </p>
 * 
...
public class Interfaz {
    /**
     * Método principal que ejecuta el menú interactivo para gestionar proyectos y tareas.
     * <p>
     * Permite al usuario seleccionar diferentes opciones para crear proyectos, agregar tareas a proyectos,
     * crear desarrolladores, actualizar el estado de las tareas y generar reportes de proyectos.
     * </p>
     * 
            ...
            switch(opcion) {
                ...
                case 4:
                    ...
                    if (tareaSeleccionada.getDesarrollador().getContrasenia().equals(contra)) {
                        ...
                        tareaSeleccionada.setEstado(nuevoEstado2);
